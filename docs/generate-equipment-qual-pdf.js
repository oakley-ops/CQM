/**
 * Generates equipment-qualification-work-instructions.pdf from the markdown source.
 * Run from docs/:
 *   node generate-equipment-qual-pdf.js
 */
...
const dir = __dirname;
const mdPath = path.join(dir, 'equipment-qualification-work-instructions.md');
const outPath = path.join(dir, 'equipment-qualification-work-instructions.pdf');

const md = fs.readFileSync(mdPath, 'utf8');

// Minimal markdown → HTML conversion (tables, headings, code, bold, italic, images, lists, hr, links, blockquotes)
...
<body>
<div class="cover">
  <h1>Equipment Qualification</h1>
  <h2 style="color:rgba(255,255,255,0.85);border:none;font-size:14pt;">Work Instruction</h2>
  <div class="meta">Document ID: WI-NEXUS-EQUIP-001 &nbsp;|&nbsp; Revision: 1.0 &nbsp;|&nbsp; Effective: 2026-09-03</div>
  <div class="meta">Owner: Quality Systems &nbsp;|&nbsp; Classification: Internal</div>
  <div class="meta" style="margin-top:20px;font-size:9pt;opacity:0.7;">Mastercard CQMAP V3.A &mdash; NEXUS Qualification Hub</div>
</div>
<div class="content">
${body}
</div>
...
const htmlPath = path.join(dir, '_temp_equip_qual.html');
