...
const createAdmin = async () => {
  ...
  try {
    ...
    const existingUser = await client.query(`SELECT id FROM users WHERE email = 'admin@pmbok.com'`);
    ...
    if (existingUser.rows.length > 0) {
      ...
      result = await client.query(`
        ...
        VALUES ($1, $2, $3, $4, $5)
        RETURNING id, email, first_name, last_name, role
      `, ['admin@pmbok.com', passwordHash, 'Admin', 'User', 'admin']);
