...
router.delete('/audits/:id/scope/:scopeId',                         v.deleteScope, validate, scopeCtrl.deleteScope);
...
router.post('/audits/:id/plans/:planId/items',                 v.createItem, validate, planCtrl.createItem);
router.patch('/audits/:id/plans/:planId/items/:itemId',        v.updateItem, validate, planCtrl.updateItem);
router.delete('/audits/:id/plans/:planId/items/:itemId',       v.deleteItem, validate, planCtrl.deleteItem);
router.post('/audits/:id/plans/:planId/items/:itemId/evidence',   v.itemEvidence, validate, nexusEvidenceUpload.single('file'), planCtrl.uploadEvidence);
router.get('/audits/:id/plans/:planId/items/:itemId/evidence',    v.itemEvidence, validate, planCtrl.downloadEvidence);
router.delete('/audits/:id/plans/:planId/items/:itemId/evidence', v.itemEvidence, validate, planCtrl.deleteEvidence);
