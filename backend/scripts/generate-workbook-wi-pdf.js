/**
 * Converts docs/workbook-work-instructions.md → docs/workbook-work-instructions.pdf
 ...
 *
 * Run:  node backend/scripts/generate-workbook-wi-pdf.js
 */
...
const MD_PATH = path.join(DOCS, 'workbook-work-instructions.md');
const OUT_PATH = path.join(DOCS, 'workbook-work-instructions.pdf');
...
<div class="cover">
  ...
  <h1>Completing the Assessment<br>Workbook in NEXUS</h1>
  <div class="cover-subtitle">Quality Control Hub — NEXUS Assessment Workbook<br>The CQM audit dry-run, step by step with screenshots</div>
  <div class="cover-meta">
    <div class="cover-meta-item"><span class="meta-label">Document</span><span class="meta-value">WI-NEXUS-WB-002</span></div>
...
<div style="width:100%;font-family:'Segoe UI',Arial,sans-serif;font-size:7.5pt;color:#999;padding:0 ${MARGIN_SIDE_MM}mm;display:table;table-layout:fixed;border-bottom:0.5px solid #e0e0e0;padding-bottom:3pt;margin-top:10mm;">
  <span style="display:table-cell;text-align:left;">WI-NEXUS-WB-002 — Completing the Assessment Workbook</span>
