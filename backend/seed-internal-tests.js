  ...
  try {
    ...
    const definitions = [
      ...
      },
      {
        ...
        is_mandatory: true,
        status: 'active',
        description: 'Verify that all four corner radii comply with ISO 7810 ID-1 (3.18 mm ± 0.30 mm) using test method #8060#.',
      },
      {
        category_id: PHY,
        test_id: '#3004#',
        ...
        test_method: '#8050#: Thickness within Add-on Areas [IS10373-1]',
        iso_standard: 'ISO/IEC 10373-1',
        test_frequency: '1/Set-up',
        test_type: 'measurement',
        unit_of_measurement: 'mm',
        max_acceptable_value: 0.05,
        is_mandatory: true,
        status: 'active',
        description: 'Relative height of Add-On areas (signature panel, hologram, etc.) per ISO/IEC 10373-1 method #8050#. Delta = avg thickness inside Add-On − avg outside thickness (#8040#). Δ must not exceed 0.05 mm.',
      },
      {
        category_id: PHY,
        test_id: 'IT-PHY-006',
